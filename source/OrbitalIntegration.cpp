...
IntegrationVector OrbitalIntegration::diff(double t, IntegrationVector){

};

std::vector<IntegrationVector> OrbitalIntegration::dormand_prince(IntegrationVector y, Date start, Date end, double h){
